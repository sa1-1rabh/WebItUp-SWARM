...
import { incrementSubTotal } from "../../store/amount";
...
const ItemCard = (props) => {
  ...
  return (
    <div className="bg-white p-2 border  relative group pb-4">
      <button
      ...
      <div>
        <div className="p-1 font-bold hover:text-blue-500 cursor-pointer">
          <p className=" truncate">{props.data.productName}</p>
        </div>
        ...
        {productQuantity == 0 ? (
          <div className="px-1">
            <button
              className=" border border-blue-500 rounded-xl w-full text-blue-500 font-bold py-2 text-md hover:bg-blue-500 hover:text-white"
